...
x264minimal=cabac=1:ref=5:deblock=-1,-1:me=umh:subme=9:psy-rd=1.00,0.15:merange=24:trellis=2:chroma-qp-offset=-1:bframes=5:b-adapt=2:direct=auto:rc-lookahead=60:vbv-maxrate=15000:vbv-bufsize=15000:aq-mode=3:partitions=all
